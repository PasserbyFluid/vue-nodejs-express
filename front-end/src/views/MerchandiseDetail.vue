      ...
      <el-main>
        <el-row :gutter="40">
          ...
          <el-col :span="12">
            <div class="image-container">
              <img :src="merchandise.productUrl" :alt="merchandise.productName" class="detail-image">
            </div>
          </el-col>
          ...
          <el-col :span="12">
            <div class="detail-info">
              ...
              <div class="rating-container">
                ...
                ></el-rate>
                <span class="rating-count">({{ merchandise.ratingCount }}人评价)</span>
              </div>
        ...
        <div class="comments-section">
          ...
          <div class="comments-list">
            <div v-for="comment in merchandise.comments" :key="comment.id" class="comment-item">
...
export default {
  ...
  methods: {
    async detail() { 
      try {
        const response = await api.get('/product/detail?productId=' + this.$route.params.id)
