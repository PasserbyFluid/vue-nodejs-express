    ...
    >
      <el-card class="payment-card">
        ...
        <div class="order-info">
          ...
          <p><strong>支付期限：</strong>{{ formatDate(order.paymentDeadline) }}</p>
        </div>
          ...
          <el-row :gutter="20">
            <el-col :span="12">
              <el-card class="payment-method-card" shadow="hover">
                <img src="@/assets/images/alipay.png" alt="支付宝二维码" class="qr-code" />
                <p class="payment-method-name">支付宝</p>
              </el-card>
            </el-col>
            <el-col :span="12">
              <el-card class="payment-method-card" shadow="hover">
                <img src="@/assets/images/wx.png" alt="微信二维码" class="qr-code" />
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="handlePaymentSuccess" class="confirm-btn">确认支付完成</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handlePaymentSuccess() {
      api.post('/order/update', { orderId: this.order.orderId,state:2 }).then(() => {
